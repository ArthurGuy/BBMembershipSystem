...
namespace DoctrineProxies\__CG__\BB\Domain;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Role extends \BB\Domain\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'BB\\Domain\\Role' . "\0" . 'name', '' . "\0" . 'BB\\Domain\\Role' . "\0" . 'title', '' . "\0" . 'BB\\Domain\\Role' . "\0" . 'description');
        }
