...
<div class="row">
    <div class="col-xs-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
        <p>
            ...
            You need to provide us with your real name and address, this is <a href="http://www.legislation.gov.uk/ukpga/2006/46/part/8/chapter/2/crossheading/general" target="_blank">required by UK law</a><br />
            Your address will be kept private but your name will be listed publicly as being a member of our community
        </p>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-md-4 col-md-offset-2 col-lg-3 col-lg-offset-3">
...
<div class="row">
    <div class="col-xs-12 col-md-4 col-md-offset-2 col-lg-3 col-lg-offset-3">
        <div class="form-group {{ $errors->has('monthly_subscription') ? 'has-error has-feedback' : '' }}">
            ...
            <span class="help-block">How much do you want to contribute each month, the average is around £20 and the minimum is £5</span>
        </div>
    </div>
</div>
