    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>
                    The members only list and is where most of the activity is including discussions about the maker space and any issues that arise.<br />
                    If your using the space at all you should be signed up to the members list so you hear about announcements or other issues.<br />
                </p>
